...
import navLogo from '../../src/imges/logo.png'
...
export const Navbar = ({ setDark }) => {
    ...
    window.addEventListener('scroll', function () {
        if (window.scrollY > 0) {
            ...
            document.querySelector('nav').style.borderBottom = " 3px   solid #9900CC";
        } else {
    ...
    const down = () => {
        document.querySelector('.nav-right').classList.toggle('down');
    }
    return (
        <nav>
            <div className="nav-right">
                ...
                <button className="animated-button">
                    ...
                    <span className="text">انشاء حساب</span>
                    ...
                    <span className="text">تسجيل الدخول</span>
                    <span className="circle"></span>
                    <svg viewBox="0 0 24 24" className="arr-1" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M16.1716 10.9999L10.8076 5.63589L12.2218 4.22168L20 11.9999L12.2218 19.778L10.8076 18.3638L16.1716 12.9999H4V10.9999H16.1716Z"
            ...
            <div className="nav-left">
                <CiMenuBurger onClick={down} className='menue' />
                <Link to="/">
                <div className='logo'>
                    <img className='nav-logo' srcSet={navLogo} alt="" />
                    <h1>MR . Mohamed Salah <br /> mathmatics</h1>
                </div>
                </Link>
                {/* toggle switch dark mode or light */}
                <label className="switch">
                    ...
                    <input type="checkbox" onClick={setDark} className="input" />
